...
namespace lab34.Views
{
    public partial class MainWindow : Window
    {
        ...
        private void OnWindowLoaded(object sender, RoutedEventArgs e) => UpdateSize();
        private void OnWindowSizeChanged(object sender, SizeChangedEventArgs e) { UpdateSize(); if (_model != null) RenderModel(_model); }
        ...
        {
            var dialog = new OpenFileDialog { Title = "Select 3D Model File", Filter = "3D Model Files (*.obj)|*.obj", DefaultExt = ".obj" };
        ...
        private void BtnWireframe_Click(object sender, RoutedEventArgs e) { _wireframeMode = !_wireframeMode; RenderModel(_model); }
        ...
        private void OnMouseMove(object sender, MouseEventArgs e)
        {
            ...
            Point delta = new Point(currentPos.X - _lastMousePos.X, currentPos.Y - _lastMousePos.Y);
        ...
        private void RenderModel(ModelData? model)
        {
            ...
            try
            {
                ...
                unsafe
                {
                    ...
                    Matrix4x4 mvp = MatrixHelper.CreateModelMatrix(_modelCenter, _rotationX, _rotationY, _modelOffsetX, _modelOffsetY) *
                                    MatrixHelper.CreateViewMatrix(_cameraPos, _modelCenter) *
                                    MatrixHelper.CreateProjectionMatrix(_width, _height);
        ...
        private unsafe void RenderSolid(ModelData model, int* buffer, int stride, Matrix4x4 modelMatrix, Matrix4x4 mvp)
        {
            foreach (var face in model.Faces)
            {
                ...
                float z1 = c1.Z / c1.W, z2 = c2.Z / c2.W, z3 = c3.Z / c3.W;
                ...
                _rasterizer?.FillTriangle(buffer, stride, sx1, sy1, z1, sx2, sy2, z2, sx3, sy3, z3, wn1, wn2, wn3, w1, w2, w3);
            }
        }
        ...
        private unsafe void RenderWireframe(ModelData model, int* buffer, int stride, Matrix4x4 mvp)
        {
            ...
            foreach (var face in model.Faces)
            {
                ...
                float nx2 = c2.X / c2.W, ny2 = c2.Y / c2.W;
                float nx3 = c3.X / c3.W, ny3 = c3.Y / c3.W;
                int sx1 = (int)((nx1 + 1f) * 0.5f * _width), sy1 = (int)((1f - ny1) * 0.5f * _height);
                int sx2 = (int)((nx2 + 1f) * 0.5f * _width), sy2 = (int)((1f - ny2) * 0.5f * _height);
                int sx3 = (int)((nx3 + 1f) * 0.5f * _width), sy3 = (int)((1f - ny3) * 0.5f * _height);
